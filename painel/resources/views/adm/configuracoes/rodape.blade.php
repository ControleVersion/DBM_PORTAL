  ...
  <div class="simplebar-content">
    <div class="container-fluid">
      ...
      <div class="jumbotron text-center">
        <p>Adminsitrar Configurações do Rodapé</p>
      </div>
      ...
      <div class="card">
        <div class="card-block">
          ...
          <ul class="nav nav-tabs">
            <li class="nav-item">
              <a class="nav-link active" href="#one" data-toggle="tab" aria-expanded="false">Rodapé</a>
            </li>
              ...
              <div class="card" id="listar-banners">
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <?php  $x=0;  ?>
                    @foreach($empresaInfos as $empresa)
                    ...
                    <tr class="<?php echo ($x == 0)?  'table-active': '';?>">
                      ...
                      <td>
                        <button onclick="javascript:window.location.href='{{asset('adm/configuracoes/editRodape/')}}/{{$empresa->id}}'" type="button" class="btn btn-white btn-sm">
